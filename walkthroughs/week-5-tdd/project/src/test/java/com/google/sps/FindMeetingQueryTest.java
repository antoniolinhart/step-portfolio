...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredWithOptionalAttendeeBlockingEntireDay() {
  ...
  public void everyAttendeeIsConsideredWithOptionalAttendee() {
    // Have each person have different events. We should see two options because each person has
    // taken up the center of the day.
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
    // Day     : |-----------------------------|
  ...
  @Test
  public void justEnoughRoomDoNotConsiderOptionalAttendee() {
    // Have one mandatory person and one optional person, ignore the optional person since it would make
  ...
  @Test
  public void tripleNestedEvents() {
    // Have 3 people, but they all have meetings at the same overlapping times with different
    // start and end times.
    // Events  :       |----A----|
    //                   |--B--|
    //                    |-C-|
  ...
  @Test
  public void everyOptionalAttendeeIsConsideredWithNoMandatory() {
    // Have each optional person have different events. We should see three options because 
  ...
  @Test
  public void notEnoughRoomWithOnlyOptionalAttendees() {
    // Have two optional people, but make it so that there is not enough room at any point 
